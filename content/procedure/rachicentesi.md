...
moduli_correlati:
  - consenso-rachicentesi
  - modulo-verde-liquor
tabelle_correlate:
  - anticoagulanti-rachicentesi
  - richieste-lcr
procedure_correlate:
  - trasfusione-emoderivati
numeri_correlati:
  - lab-neurologia
  - lab-urgenze-giustinianeo
  - microbiologia-accettazione
  - citodiagnostica
...
Le rachicentesi si eseguono la mattina, dopo il giro visite, con lo strutturato presente (oppure nelle guardie festive, se urgenti).
...
> 💡 **Tip**: Prelevare 2-3 cc extra in una provetta supplementare, da stoccare nel Laboratorio di Neurologia per eventuali richieste aggiunte successive.

## Esecuzione

Effettuare la puntura lombare e il prelievo con l'aiuto di almeno un'infermiera e la supervisione dello strutturato.
...
> Previa raccolta del consenso informato (firmato e in cartella), eseguita rachicentesi in posizione seduta. Procedura eseguita senza complicanze peri e post-procedurali, ben tollerata, in assenza di traumatismo significativo. Si prelevano circa 10 cc di liquor limpido come acqua di rocca, a goccia rapida, in 2 aliquote: rispettivamente 1 aliquota per esame chimico-fisico, 1 aliquota da conservare in frigorifero nel nostro laboratorio. Si dispone per riposo a letto ed abbondante idratazione.

## Spedizione verso altri centri

Se servono indagini non eseguibili in azienda (autoanticorpi rari, RT-QuIC per prionica, genetica miopatie), organizzare spedizione per i giorni successivi:

1. Chiamare il **Magazzino** (3876 / 3877) e ordinare 5 kg di ghiaccio secco, concordando la data
2. Reperire **pacco di polistirolo** (chiedere in Lab Neurologia o in DH)
3. Compilare **modulo giallo** nel blocchetto in stanza Coordinatrice per richiesta ghiaccio secco
4. Preparare **relazione clinica** completa (storia, clinica, esami ematochimici e liquorali, imaging, neuropsicologia se presente)
5. Compilare e far firmare **modulo consenso raccolta dati**
6. Il giorno della spedizione, ore 7.45-8.00, recarsi in Magazzino con il pacco
